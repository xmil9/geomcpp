//
// geomcpp tests
// Tests for 2D line segments using compile time polymorphism.
//
...
{
   {
      const std::string caseLabel = "s[ct] LineSeg2 default ctor for float";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2 default ctor for integer";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2 start-end point ctor for float";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2 start-end point ctor for integer";
   ...
   }
   {
      const std::string caseLabel =
         "[ct] LineSeg2 start-end point ctor for constexpr definitions";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2 start-direction ctor for float";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2 start-direction ctor for integer";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2 start-direction ctor for constexpr definitions";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2::type";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2::isPoint for line that is not a point";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::isPoint for line that is a point";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2::startPoint";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2::endPoint";
...
void testLineSeg2IsPointOnLine()
{
   {
      const std::string caseLabel =
         "[ct] LineSeg2::isPointOnLine for point that is on line";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::isPointOnLine for point that is next to line";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::isPointOnLine for point that is on infinite "
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::isPointOnLine for point that is on "
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::isPointOnLine for start point";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::isPointOnLine for end point";
...
void testLineSeg2IsPointOnInfiniteLine()
{
   {
      const std::string caseLabel =
         "[ct] LineSeg2::isPointOnInfiniteLine for point that is on line";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::isPointOnInfiniteLine for point that is next to line";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::isPointOnInfiniteLine for point that is on infinite "
         "line extension before the anchor point";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::isPointOnInfiniteLine for point that is on infinite ray";
...
void testLineSeg2LerpFactor()
{
   {
      const std::string caseLabel =
         "[ct] LineSeg2::lerpFactor for point within length of directional vector";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::lerpFactor for point past the length of directional vector";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::lerpFactor for point before the anchor point";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::lerpFactor for point not on line";
...
void testLineSeg2Lerp()
{
   {
      const std::string caseLabel =
         "[ct] LineSeg2::lerp for point within length of directional vector";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::lerp for point past the length of directional vector";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::lerp for point before the anchor point";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::lerp with zero";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::lerp with integer value";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2::midPoint";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::midPoint when line is point";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2::lengthSquared";
   ...
   {
      const std::string caseLabel =
         "[ct] LineSeg2::lengthSquared for line that is a point";
...
{
   {
      const std::string caseLabel = "[ct] LineSeg2::length";
   ...
   {
      const std::string caseLabel = "[ct] LineSeg2::length for line that is a point";
...
{
   {
      const std::string caseLabel = "[ct] parallel() for parallel line segments";
   ...
   {
      const std::string caseLabel = "[ct] parallel() for non-parallel line segments";
   ...
   {
      const std::string caseLabel = "[ct] parallel() for mixed line segment types";
...
{
   {
      const std::string caseLabel = "[ct] coincident() for coincident line segments";
   ...
   {
      const std::string caseLabel = "[ct] coincident() for non-coincident line segments";
   ...
   {
      const std::string caseLabel = "[ct] coincident() for mixed line segment types";
...
{
   {
      const std::string caseLabel = "[ct] Equality for equal line segments";
   ...
   {
      const std::string caseLabel =
         "[ct] Equality for line segments with different anchors";
...
{
   {
      const std::string caseLabel = "[ct] Inequality for equal line segments";
   ...
   {
      const std::string caseLabel =
         "[ct] Inequality for line segments with different anchors";
